...
``platform.db.privileges``). The append-only trigger from ``202607280001_platform_append_only``
is the unconditional backstop; this migration is the privilege layer above it.

Revision ID: 202607300001_platform_evidentiary_privileges
Revises: 202607280001_platform_append_only
"""
...
revision = "202607300001_platform_evidentiary_privileges"
down_revision = "202607280001_platform_append_only"
branch_labels = None
depends_on = None

"""Alembic environment for the ``social_media`` schema (guide Part 4).

Per-module migration ownership: this env manages ONLY the ``social_media`` schema
...
import sentinelai.modules.social_media.models  # noqa: F401  (registers models on Base.metadata)
from sentinelai.platform.config import settings
from sentinelai.platform.db.base import Base

VERSION_TABLE_SCHEMA = "social_media"

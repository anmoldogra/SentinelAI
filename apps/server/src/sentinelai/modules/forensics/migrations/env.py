"""Alembic environment for the ``forensics`` schema (guide Part 4).

Per-module migration ownership: this env manages ONLY the ``forensics`` schema
...
import sentinelai.modules.forensics.models  # noqa: F401  (registers models on Base.metadata)
from sentinelai.platform.config import settings
from sentinelai.platform.db.base import Base

VERSION_TABLE_SCHEMA = "forensics"

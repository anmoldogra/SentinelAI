"""Alembic environment for the ``threat_intel`` schema (guide Part 4).

Per-module migration ownership: this env manages ONLY the ``threat_intel`` schema
...
import sentinelai.modules.threat_intel.models  # noqa: F401  (registers models on Base.metadata)

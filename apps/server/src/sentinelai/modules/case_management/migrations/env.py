"""Alembic environment for the ``case_management`` schema (guide Part 4).

Per-module migration ownership: this env manages ONLY the ``case_management`` schema
...
import sentinelai.modules.case_management.models  # noqa: F401  (registers models on Base.metadata)
from sentinelai.platform.config import settings
from sentinelai.platform.db.base import Base

VERSION_TABLE_SCHEMA = "case_management"

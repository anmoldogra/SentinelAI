"""Alembic environment for the ``osint`` schema (guide Part 4).

Per-module migration ownership: this env manages ONLY the ``osint`` schema
...
import sentinelai.modules.osint.models  # noqa: F401  (registers models on Base.metadata)

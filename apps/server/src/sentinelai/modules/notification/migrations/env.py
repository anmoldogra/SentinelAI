"""Alembic environment for the ``notification`` schema (guide Part 4).

Per-module migration ownership: this env manages ONLY the ``notification`` schema
...
import sentinelai.modules.notification.models  # noqa: F401  (registers models on Base.metadata)
